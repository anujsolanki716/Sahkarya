...
import BinPost from "../components/Admin/BinPost";
  ...
  useEffect(() => {
    socket.on("message", (message) => {
      ...
      if (
        ...
        setStatus(incomingData.binStatus);
    ...
    <>
      <div className="gridContainer">
        ...
        <div className="rightContainer">
          <div className="upperPanel" style={{ background: "#41B06E" }}>
          ...
          <div className="card-map">
            {togglePost && <BinPost address={address} date={date} status = {status} />}
            <div className="mapContainer">
              <div style={{ width: "100%", height: "100%" }}>
                <BinMap markerData={markerData} mapProps={MapProps} />
              </div>
            </div>
          </div>
        </div>
